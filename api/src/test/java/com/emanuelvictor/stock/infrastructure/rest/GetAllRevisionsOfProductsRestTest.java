...
public class GetAllRevisionsOfProductsRestTest extends SpringBootTests {
    ...
    @Test
    void mustGetAllRevisionsOfAllProductsThatHaveUpdates() throws Exception {
        ...
        final var result = mockMvc.perform(MockMvcRequestBuilders
                .get("/api/stocks/products/revisions")
