...
import com.emanuelvictor.erp.tenants.application.adapters.primaries.getalltenants.TenantDTO;
...
import static com.emanuelvictor.erp.tenants.application.adapters.secundaries.TenantDAO.dropAllTenants;
...
public class GetAllTenantsRestTest extends AbstractIntegrationTests {
    ...
    void mustGetAllTenants() throws Exception {
        ...
        var result = mockMvc.perform(get("/api/tenants"))
