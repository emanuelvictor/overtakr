package com.emanuelvictor.erp.tenants.infrastructure.multitenant.database;
...
import static com.emanuelvictor.erp.tenants.application.adapters.secundaries.TenantDAO.getAllCostumerTenants;
