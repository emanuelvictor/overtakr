...
import {PageSerialize} from '../../../common/domain/repository/page-serialize/page-serialize';
...
export class UserRepository extends BaseRepository<User> {
  ...
  constructor(httpClient: HttpClient) {
    super(httpClient, 'api/access-manager/users');
  }
   ...
   * @returns {Observable<{}>}
   */
  public changePassword(user: User, newPassword: string): Promise<User|undefined> {
