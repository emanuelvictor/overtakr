...
// @ts-ignore
@Component({selector: 'crud-view', template: '', standalone: false})
export class CrudViewComponent implements CrudViewInterface {
  ...
  @Input() subhead: string | undefined; // Armazena o subtítulo padrão da página
  @Input() gender: Gender | undefined; // Armazena o gênero da entidade para tratar as labels conforme o mesmo
  ...
  constructor(public snackBar: MatSnackBar,
              ...
              public fb: FormBuilder, public renderer: Renderer2,
        ...
        if (control.controls && control.invalid) {
          for (const controlInner of control.controls) {
            ...
            if (elemento && controlInner.invalid) {
              this.renderer.selectRootElement(elemento).focus();
              valid = false;
